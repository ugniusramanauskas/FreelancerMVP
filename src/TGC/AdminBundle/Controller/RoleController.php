...
use TGC\AdminBundle\Entity\Role;
use TGC\AdminBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TGCAdminBundle:Role')->findAll();

        return $this->render('TGCAdminBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TGCAdminBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TGCAdminBundle:Role')->find($id);
        ...
        return $this->render('TGCAdminBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TGCAdminBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
